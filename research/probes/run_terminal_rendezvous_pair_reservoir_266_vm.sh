...
root="${1:-/home/LMC/udon266-0831}"
manifest="$root/SCORE-TERMINAL-RENDEZVOUS-PAIR-RESERVOIR-266.csv"
binary="$root/udonshield_historical_tournament"
output_dir="$root/logs266-holdout"
expected_manifest_sha="6b00471ef05dd3611fa34a90b6c923067ecd64c266e5b6ba07c325e2ddf66a82"
...
combined_partial="$output_dir/SCORE-TERMINAL-RENDEZVOUS-PAIR-RESERVOIR-266-holdout.log.partial.$$"
combined="$output_dir/SCORE-TERMINAL-RENDEZVOUS-PAIR-RESERVOIR-266-holdout.log"
{
  echo "run_begin,experiment=SCORE-TERMINAL-RENDEZVOUS-PAIR-RESERVOIR-266,phase=holdout,expected_results=54"
