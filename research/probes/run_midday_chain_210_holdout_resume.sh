#!/usr/bin/env bash
# SCORE-MIDDAY-CHAIN-ADOPTION-210 sealed-holdout resume wrapper. Same-binary
...
# Usage: run_midday_chain_210_holdout_resume.sh <binary> <side:off|on> <logdir>
set -euo pipefail
binary="$1"
side="$2"
logdir="$3"
...
log="$logdir/SCORE-MIDDAY-CHAIN-ADOPTION-210-holdout-causal-$side.log"
...
run_tier stratified-easy 4930000 16 4 12 14
run_tier stratified-medium 4931000 16 4 12 18
run_tier stratified-hard 4932000 36 6 18 24
run_tier stratified-very-hard 4933000 40 8 18 24 30
