param(
    ...
    [string]$Output = "research/evidence/ATTR-MULTITEAM-HIGH-FUEL-LONG-HORIZON-THROUGHPUT-270-sparse.log",
    [switch]$Resume
)
...
if ($finalCompleted -ne 63) {
    throw "Expected 63 complete cases, found $finalCompleted"
}
[System.IO.File]::AppendAllText($Output, "run_complete cases=63 max_states=50000 max_routes=64$([Environment]::NewLine)", $utf8NoBom)
