param(
    ...
    [string]$Manifest = "research/holdouts/ATTR-TRAFFIC-NONINCREASING-SPARSE-YIELD-279.csv",
    [string]$Output = "research/evidence/ATTR-TRAFFIC-NONINCREASING-SPARSE-YIELD-279.log",
    [switch]$Resume
)

$ErrorActionPreference = "Stop"
$expectedProbe = "07DB64EDD350A9F1B56D18818E64D5CA75EE7D12387DD3622F1BCB6C533ECCFD"
$expectedProbeSource = "7E8D4BC7937BCE0E865E1615C0D8573C14CBAE1AC5A98EAE8A5E936528319BA9"
